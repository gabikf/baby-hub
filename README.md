                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script ouro hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://70514002595374" }),
    Setting = Window:AddTab({ Title = "Setting", Icon = "rbxassetid://123985783159497" }),
    Stats = Window:AddTab({ Title = "Stats", Icon = "rbxassetid://107446352712953" }),
    Player = Window:AddTab({ Title = "Player", Icon = "rbxassetid://117379409912683" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "rbxassetid://75539505506015" }),
    Fruit = Window:AddTab({ Title = "Fruit", Icon = "rbxassetid://126387568122003" }),
    Raid = Window:AddTab({ Title = "Raid", Icon = "rbxassetid://105091825925437" }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "rbxassetid://82013450694131" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "rbxassetid://79643860089505" }),
	Misc = Window:AddTab({ Title = "Misc", Icon = "rbxassetid://99610179841965" }),
}
